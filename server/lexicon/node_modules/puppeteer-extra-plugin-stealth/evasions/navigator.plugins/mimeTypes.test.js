  ...
  const results = await page.evaluate(() => {
    ...
    return {
      mimeTypes: {
        ...
        toStringProto: navigator.mimeTypes.__proto__.toString(), 
        protoSymbol: navigator.mimeTypes.__proto__[Symbol.toStringTag], 
        ...
        namedPropsAuthentic: (function() {
          ...
          return navigator.mimeTypes.namedItem('alice') === null 
        })(),
        loopResult: (function() {
          let res = ''
      ...
      namedItem: {
        ...
        resultFound: navigator.mimeTypes 
        ...
        errors: {
          ...
          protoCall: catchErr.bind(navigator.mimeTypes)(
            navigator.mimeTypes.__proto__.namedItem 
          ).str
        }
      },
      item: {
        ...
        errors: {
          ...
          noStackLeaks: !catchErr
            ...
            .stack.includes(`.apply`),
          protoCall: catchErr.bind(navigator.mimeTypes)(
            navigator.mimeTypes.__proto__.item 
          ).str
        }
      }
    }
...
test('stealth: will have convincing mimeType entry', async t => {
  ...
  const results = await page.evaluate(() => ({
    mimeType: {
      ...
      toStringProto: navigator.mimeTypes[0].__proto__.toString(), 
      protoSymbol: navigator.mimeTypes[0].__proto__[Symbol.toStringTag], 
      enabledPlugin: !!navigator.mimeTypes[0].enabledPlugin, 
      enabledPlugin2: !!navigator.mimeTypes['application/pdf'].enabledPlugin, 
      enabledPlugins: !!navigator.mimeTypes[0].enabledPlugins, 
